...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,jenkins,gitlab,github,django,git,idea,java,linux,postman,py,react,ts,flutter,docker,bootstrap,ansible,angular,nodejs.spring,bash,PHP,wordpress)](https://skillicons.dev)
